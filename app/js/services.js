app.service('AddressSearchService', function($http, NgMap, $route){
  ...
  createAPIURL: function(addressObj) {
    let baseURL = "https://api.airdna.co/v1/rentalizer/estimate?access_token=NTE4OQ|906b190a6082428d904238278819b91c"
    ...
    let queryURL = `${baseURL}&address=${urlAddress}&zipcode=${addressObj.zip}`
      ...
      console.log('airdna url:', queryURL);
      return queryURL
    },
    getCurrentStreetViewImg: function (addressObj) {
      ...
      console.log('gmaps url', gMapsBaseURL+middle+end);
